    ...
    <Router>
      <Routes>
        ...
        <Route path="/stock" element={<MainLayout />}>
          ...
          <Route
            path="history/pemasukkan"
            index
            element={<HistoryAllBahanMasuk />}
          />
          <Route
            path="history/pemasukkan/:id"
            index
            element={<HistoryAllBahanMasukDetailPage />}
          />
          <Route
            path="history/keluar"
            index
            element={<HistoryAllBahanKeluarPage />}
          />
          <Route
            path="history/keluar/:id"
            index
            element={<HistoryAllBahanKeluarDetailPage />}
          />
          <Route
            path="detail/pemakaian/:id"
            index
            element={<ListPemakaianBahanDetailPage />}
          />
          <Route path="bahansisa" index element={<LihatBahanSisaPage />} />
        </Route>
        <Route path="/report" element={<MainLayout />}>
          <Route
            path="laporan/hpp"
            index
            element={<GenerateLaporanHppPage />}
          ></Route>
          <Route
            path="laporan/bahan-masuk"
            index
            element={<GenerateLaporanBahanMasuk />}
          ></Route>
          <Route
            path="laporan/bahan-keluar"
            index
            element={<GenerateLaporanBahanKeluar />}
          ></Route>
          <Route
            path="laporan/nota-by-supplier"
            index
            element={<GenerateLaporanNotaBySupplier />}
          ></Route>
          <Route
            path="laporan/nota-by-tanggal"
            index
            element={<GenerateLaporanNotaByTanggal />}
          ></Route>
        </Route>
