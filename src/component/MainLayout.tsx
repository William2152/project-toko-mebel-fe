            ...
            <>
              ...
              <List>
                ...
                <ListItem disablePadding>
                  ...
                  >
                    <ListItemIcon
                      sx={{ pl: 5, color: "white", fontSize: ukIcon }}
                    >
                  ...
                  <List component="div" disablePadding>
                    ...
                    >
                      <ListItemText
                        ...
                        primary="List Pemakaian Bahan"
                      />
                    </ListItemButton>
                    <ListItemButton
                      component={NavLink}
                      to="/stock/history/pemasukkan"
                      sx={{ pl: 13 }}
                    >
                      <ListItemText
                        primaryTypographyProps={{
                        ...
                        primary="History Bahan Masuk"
                      />
                    </ListItemButton>
                    <ListItemButton
                      component={NavLink}
                      to="/stock/history/keluar"
                      sx={{ pl: 13 }}
                    >
                      <ListItemText
                        primaryTypographyProps={{
              ...
              <Collapse in={isReportOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  ...
                  <ListItemButton
                    component={NavLink}
                    to="/report/laporan/nota-by-supplier"
                    sx={{ pl: 13 }}
                  >
                    <ListItemText
                      primaryTypographyProps={{ sx: { fontSize: ukSubTitle } }}
                      primary="Laporan Nota Per Supplier"
                    />
                  </ListItemButton>
                  <ListItemButton
                    component={NavLink}
                    to="/report/laporan/nota-by-tanggal"
                    sx={{ pl: 13 }}
                  >
                    <ListItemText
                      primaryTypographyProps={{ sx: { fontSize: ukSubTitle } }}
                      primary="Laporan Nota Per Tanggal"
                    />
                  </ListItemButton>
                  <ListItemButton
                    component={NavLink}
                    to="/report/laporan/bahan-masuk"
                    sx={{ pl: 13 }}
                  >
                    <ListItemText
                      primaryTypographyProps={{ sx: { fontSize: ukSubTitle } }}
                      primary="Laporan Bahan Masuk"
                    />
                  </ListItemButton>
                  <ListItemButton
                    component={NavLink}
                    to="/report/laporan/bahan-keluar"
                    sx={{ pl: 13 }}
                  >
                    <ListItemText
                      primaryTypographyProps={{ sx: { fontSize: ukSubTitle } }}
                      primary="Laporan Bahan Keluar"
                    />
                  </ListItemButton>
                </List>
              </Collapse>
              ...
              <Collapse in={isUserOpen} timeout="auto" unmountOnExit>
                <List component="div" disablePadding>
                  ...
                  >
                    <ListItemText
                      primaryTypographyProps={{ sx: { fontSize: ukSubTitle } }}
                      primary="Tambah Customer / Supplier"
                    />
                  </ListItemButton>
                  <ListItemButton
                    component={NavLink}
